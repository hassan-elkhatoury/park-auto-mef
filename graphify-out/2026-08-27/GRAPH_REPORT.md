...
## Corpus Check
- 304 files · ~198,434 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1980 nodes · 5703 edges · 104 communities (96 shown, 8 thin omitted)
...
- `BudgetView()` --calls--> `directionShort()`  [EXTRACTED]
  park-auto-frontend/src/components/BudgetView.jsx → park-auto-frontend/src/utils/vehicule.jsx
...
Cohesion: 0.17
Nodes (16): com.lowagie.text.Document, com.lowagie.text.Font, com.lowagie.text.Image, com.lowagie.text.Paragraph, com.lowagie.text.pdf.PdfPageEventHelper, com.lowagie.text.pdf.PdfPCell, com.lowagie.text.pdf.PdfPTable, com.lowagie.text.pdf.PdfWriter (+8 more)

### Community 1 - "BudgetView.jsx"
Cohesion: 0.22
Nodes (9): AssurancesView(), BudgetView(), DIRECTIONS, MOIS_NOMS, NATURES_DEPENSE, PALETTE, VisitesTaxesReformeView(), getApiErrorMessage() (+1 more)
...
Cohesion: 0.10
Nodes (16): GetMapping, PostMapping, PutMapping, AllArgsConstructor, Builder, Data, NoArgsConstructor, VisiteTechniqueDto (+8 more)
...
Cohesion: 0.08
Nodes (24): org.springframework.core.io.Resource, org.springframework.web.multipart.MultipartFile, DocumentGEDController, DeleteMapping, GetMapping, PostMapping, RequestMapping, RestController (+16 more)
...
Cohesion: 0.06
Nodes (26): GetMapping, PostMapping, PutMapping, AllArgsConstructor, Builder, Data, NoArgsConstructor, ReformeVehiculeDto (+18 more)

### Community 10 - "GarageAgreeController"
Cohesion: 0.18
Nodes (6): GarageAgreeController, DeleteMapping, GetMapping, PostMapping, RequestMapping, RestController
...
Cohesion: 0.06
Nodes (28): InfractionController, DeleteMapping, GetMapping, PostMapping, PutMapping, RequestMapping, RestController, InfractionDto (+20 more)

### Community 15 - "org.springframework.transaction.annotation.Transactional"
Cohesion: 0.16
Nodes (5): org.springframework.transaction.annotation.Transactional, ConducteurDto, GarageAgreeDto, ConducteurService, GarageAgreeService

### Community 16 - "App.jsx"
Cohesion: 0.07
Nodes (23): App(), isJwtValid(), AffectationDetailView(), fmtDateTime(), AffectationsView(), actionConfig, AuditView(), ConducteurDetailView() (+15 more)

### Community 17 - "InterventionMaintenance"
Cohesion: 0.11
Nodes (13): InterventionMaintenanceRequest, InterventionMaintenance, StatutMaintenance, ANNULEE, EN_COURS, PROGRAMMEE, TERMINEE, TypeMaintenance (+5 more)

### Community 18 - ".success"
Cohesion: 0.14
Nodes (9): org.springframework.web.bind.annotation.PutMapping, DeleteMapping, GetMapping, PostMapping, PutMapping, RequestMapping, RestController, MaintenanceController (+1 more)

### Community 19 - "org.springframework.data.jpa.repository.JpaRepository"
Cohesion: 0.08
Nodes (21): org.springframework.data.jpa.repository.JpaRepository, org.springframework.stereotype.Repository, ExerciceBudgetaire, AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor (+13 more)

### Community 20 - "lombok.AllArgsConstructor"
Cohesion: 0.13
Nodes (19): com.fasterxml.jackson.annotation.JsonInclude, lombok.AllArgsConstructor, lombok.Builder, lombok.Data, lombok.NoArgsConstructor, AlerteEcheanceDto, ClotureExerciceRequest, ClotureExerciceRequestBuilder (+11 more)

### Community 21 - "api.js"
Cohesion: 0.14
Nodes (18): COMPAGNIES, GARANTIES, NATURES_ACCIDENT, SinistresView(), STATUTS_SINISTRE, RESULTATS_VISITE, STATUTS_REFORME, TYPES_TAXE (+10 more)

### Community 22 - "UtilisateurServiceImpl.java"
Cohesion: 0.11
Nodes (14): org.springframework.security.crypto.password.PasswordEncoder, UtilisateurRequest, UserStatus, ACTIVE, ARCHIVED, INACTIVE, LOCKED, DuplicateResourceException (+6 more)

### Community 23 - "Vehicule"
Cohesion: 0.19
Nodes (13): jakarta.persistence.Entity, jakarta.persistence.EntityListeners, jakarta.persistence.MappedSuperclass, jakarta.persistence.Table, lombok.Getter, lombok.Setter, BaseEntity, HistoriqueStatutVehicule (+5 more)

### Community 24 - "DashboardView.jsx"
Cohesion: 0.08
Nodes (10): CarburantView(), DashboardView(), DEMAND_STATUS, FUEL_COLORS, isMaintenance(), ROLE_DESCRIPTIONS, ROLE_LABELS, TOOLTIP_STYLE (+2 more)

### Community 25 - "StatutAdministratif"
Cohesion: 0.05
Nodes (40): org.mapstruct.BeanMapping, org.mapstruct.Mapper, org.mapstruct.Mapping, HistoriqueStatutResponse, StatutChangeRequest, VehiculeRequest, EtatTechnique, ACCIDENTE (+32 more)

### Community 26 - "lombok.RequiredArgsConstructor"
Cohesion: 0.13
Nodes (28): io.swagger.v3.oas.annotations.security.SecurityRequirement, io.swagger.v3.oas.annotations.tags.Tag, lombok.extern.slf4j.Slf4j, lombok.RequiredArgsConstructor, org.springframework.stereotype.Service, org.springframework.web.bind.annotation.RequestMapping, org.springframework.web.bind.annotation.RestController, AffectationController (+20 more)

### Community 27 - "Sinistre"
Cohesion: 0.05
Nodes (36): DeleteMapping, GetMapping, PostMapping, PutMapping, RequestMapping, RestController, SinistreController, AllArgsConstructor (+28 more)

### Community 28 - "vehicule.jsx"
Cohesion: 0.15
Nodes (20): PALETTE, RapportsView(), formatDate(), formatKm(), VehiculeDetailView(), CAR_BRANDS_AND_MODELS, EMPTY_FORM, fetchNextInventaireNumber() (+12 more)

### Community 29 - "PanneDto"
Cohesion: 0.07
Nodes (21): GetMapping, PostMapping, PutMapping, RequestMapping, RestController, PanneController, CloturePanneRequest, PanneDto (+13 more)
...
Cohesion: 0.10
Nodes (16): org.springframework.data.jpa.repository.Query, CarteCarburantDto, PleinCarburantDto, PleinCarburantRequest, CarteCarburant, CarteCarburantStatut, ACTIVE, DESACTIVEE (+8 more)
...
Cohesion: 0.14
Nodes (10): RoleResponse, RoleType, ADMIN, CONDUCTEUR, CONSULTATION, GESTIONNAIRE_CENTRAL, GESTIONNAIRE_LOCAL, RESPONSABLE_FINANCIER (+2 more)

### Community 34 - "VehiculeServiceImpl.java"
Cohesion: 0.20
Nodes (4): VehiculeResponse, VehiculeServiceImpl, VehiculeService, AppConstants

### Community 35 - "DataInitializer"
Cohesion: 0.10
Nodes (14): JdbcTemplate, org.springframework.boot.CommandLineRunner, DataInitializer, Override, PrePersist, AllArgsConstructor, Entity, Getter (+6 more)
...
### Community 37 - "ResourceNotFoundException"
Cohesion: 0.09
Nodes (4): DeleteMapping, DeleteMapping, BadRequestException, ResourceNotFoundException
...
### Community 41 - "UtilisateurResponse"
Cohesion: 0.11
Nodes (14): org.springframework.security.authentication.AuthenticationManager, ChangePasswordRequest, LoginRequest, LoginResponse, RefreshTokenRequest, RegisterRequest, UpdateRolesRequest, UtilisateurResponse (+6 more)

### Community 42 - "AssuranceService"
Cohesion: 0.16
Nodes (11): AssuranceController, DeleteMapping, PostMapping, PutMapping, RequestMapping, RestController, AssuranceRequest, AllArgsConstructor (+3 more)

### Community 43 - "Conducteur"
Cohesion: 0.11
Nodes (12): Affectation, Conducteur, StatutAffectation, ANNULEE, EN_COURS, RESTITUEE, StatutConducteur, ACTIF (+4 more)
...
Cohesion: 0.15
Nodes (13): io.jsonwebtoken.Claims, jakarta.servlet.FilterChain, jakarta.servlet.http.HttpServletResponse, javax.crypto.SecretKey, org.springframework.security.core.userdetails.UserDetails, org.springframework.security.core.userdetails.UserDetailsService, org.springframework.stereotype.Component, org.springframework.web.filter.OncePerRequestFilter (+5 more)

### Community 50 - "CarburantController"
Cohesion: 0.18
Nodes (6): CarburantController, DeleteMapping, GetMapping, PostMapping, RequestMapping, RestController

### Community 51 - "react"
Cohesion: 0.33
Nodes (5): ConfirmModal(), URGENCES, roleBadgeStyles, garageService, react
...
### Community 59 - "org.springframework.data.domain.Pageable"
Cohesion: 0.23
Nodes (10): org.springframework.data.domain.Pageable, GetMapping, RequestMapping, RestController, JournalController, JournalAction, JournalActionRepository, Override (+2 more)
...
Cohesion: 0.18
Nodes (6): GetMapping, AssuranceDto, AllArgsConstructor, Builder, Data, NoArgsConstructor

### Community 64 - "org.springframework.http.ResponseEntity"
Cohesion: 0.12
Nodes (10): io.swagger.v3.oas.annotations.Operation, org.springframework.http.ResponseEntity, org.springframework.security.access.prepost.PreAuthorize, org.springframework.web.bind.annotation.DeleteMapping, org.springframework.web.bind.annotation.GetMapping, org.springframework.web.bind.annotation.PatchMapping, org.springframework.web.bind.annotation.PostMapping, ConducteurController (+2 more)

### Community 65 - "ExerciceBudgetaireDto"
Cohesion: 0.22
Nodes (6): ExerciceBudgetaireDto, AllArgsConstructor, Builder, Getter, NoArgsConstructor, Setter
...
### Community 69 - "TcoConsolidationDto"
Cohesion: 0.14
Nodes (12): AllArgsConstructor, Builder, Getter, NoArgsConstructor, Setter, TcoConsolidationDto, AllArgsConstructor, Builder (+4 more)
...
### Community 75 - "org.springframework.data.domain.Page"
Cohesion: 0.10
Nodes (21): jakarta.servlet.http.HttpServletRequest, org.springframework.data.domain.Page, AuditLogController, GetMapping, RequestMapping, RestController, AuditLogDto, AllArgsConstructor (+13 more)
...
### Community 101 - "BudgetController"
Cohesion: 0.06
Nodes (26): org.springframework.security.core.Authentication, BudgetController, DeleteMapping, GetMapping, PostMapping, PutMapping, RestController, BudgetDirectionDto (+18 more)
...
- **Why does `ResourceNotFoundException` connect `ResourceNotFoundException` to `ReportingService`, `VisiteTechniqueDto`, `DocumentGED`, `ReformeVehiculeDto`, `org.springframework.transaction.annotation.Transactional`, `InterventionMaintenance`, `UtilisateurServiceImpl.java`, `lombok.RequiredArgsConstructor`, `PanneDto`, `ApiResponse`, `org.springframework.data.jpa.repository.Query`, `VehiculeServiceImpl.java`, `BudgetService`, `UtilisateurResponse`, `AssuranceService`, `Conducteur`, `DemandeDeplacement`, `.create`, `AssuranceDto`, `ExerciceBudgetaireDto`, `AffectationService`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Vehicule` connect `Vehicule` to `ReportingService`, `VehiculeServiceImpl.java`, `DataInitializer`, `Sprint7BudgetDashboardTests`, `TaxeAutomobile`, `PrevisionCarburant`, `ReformeVehiculeDto`, `Conducteur`, `Assurance`, `Infraction`, `InterventionMaintenance`, `org.springframework.data.jpa.repository.JpaRepository`, `lombok.AllArgsConstructor`, `.create`, `StatutAdministratif`, `lombok.RequiredArgsConstructor`, `Sinistre`, `org.springframework.data.jpa.repository.Query`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `BaseEntity` connect `Vehicule` to `EngagementBudgetaire`, `DataInitializer`, `TaxeAutomobile`, `BudgetDirection`, `PrevisionCarburant`, `ReformeVehiculeDto`, `Conducteur`, `Assurance`, `DemandeDeplacement`, `Infraction`, `InterventionMaintenance`, `org.springframework.data.jpa.repository.JpaRepository`, `Utilisateur`, `Sinistre`, `org.springframework.data.jpa.repository.Query`?**
...
- **Should `TaxeAutomobile` be split into smaller, more focused modules?**
